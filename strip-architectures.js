...
module.exports = function (ctx) {
    ...
    const options = {
        shellPath: '/bin/sh',
        shellScript: 'bash \"$BUILT_PRODUCTS_DIR/$FRAMEWORKS_FOLDER_PATH/ScanbotBarcodeScannerSDK.framework/strip-SBSDK-Framework.sh\"',
        inputPaths: ['"$(SRCROOT)/../../plugins/cordova-plugin-scanbot-barcode-scanner/src/ios/Frameworks/ScanbotBarcodeScannerSDK.framework.dSYM"']
    };
